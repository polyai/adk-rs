...
class Conversation:
    ...
    def log_api_response(self, response: requests.models.Response, override_url: str | None = None): ...
    ...
    def call_handoff(self, destination: str, reason: str | None = None, utterance: str | None = None, sip_headers: dict[str, str] | None = None, route: str | None = None): ...
