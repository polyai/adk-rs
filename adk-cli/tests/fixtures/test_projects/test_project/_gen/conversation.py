...
class ElevenLabsVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, similarity_boost: float | None = None, stability: float | None = None, model_id: Literal['eleven_monolingual_v1', 'eleven_multilingual_v1', 'eleven_turbo_v2', 'eleven_turbo_v2_5', 'eleven_flash_v2_5'] | None = 'eleven_turbo_v2_5', speed: float | None = None) -> None: ...
    @property
...
class RimeVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, speech_alpha: float | None = 1.0, model_id: Literal['mist', 'mistv2'] | None = 'mistv2') -> None: ...
    @property
...
class Emotion:
    kind: Any
    intensity: Any
    def __init__(self, kind: EmotionKindValue | None = None, intensity: EmotionIntensityValue | None = None) -> None: ...
    def to_dict(self) -> dict: ...

class CartesiaVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, speed: float | None = 0, emotions: list[Emotion] | None = None, model_id: str | None = 'sonic', volume: float | None = None, emotion: str | None = None, language: str | None = None) -> None: ...
    @property
...
class PlayHTVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, speed: float | None = None, temperature: float | None = None, emotion: Literal['female_happy', 'female_sad', 'female_angry', 'female_fearful', 'female_disgust', 'female_surprised', 'male_happy', 'male_sad', 'male_angry', 'male_fearful', 'male_disgust', 'male_surprised'] | None = None, voice_guidance: int | None = None, style_guidance: int | None = None, voice_engine: Literal['Play3.0-mini', 'PlayDialog', 'PlayHT2.0-turbo', 'PlayHT2.0', 'PlayHT1.0'] | None = None) -> None: ...
    @property
    def temperature(self) -> float | None: ...

class MinimaxVoice(TTSVoice):
    def __init__(self, model_id: Literal['speech-02-hd', 'speech-02-turbo', 'speech-01-hd', 'speech-01-turbo'], voice_id: str, speed: float | None = None, vol: float | None = None, pitch: float | None = None, emotion: Literal['happy', 'sad', 'angry', 'fearful', 'disgusted', 'surprised', 'neutral'] | None = None) -> None: ...
    @property
...
class HumeVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, voice_description: str | None = None, version: str | None = '2', instant_mode: bool | None = False, provider: Literal['CUSTOM_VOICE', 'HUME_AI'] | None = 'CUSTOM_VOICE') -> None: ...

class GoogleVoice(TTSVoice):
    def __init__(self, provider_voice_id: str, gender: Literal['male', 'female', 'neutral'] | None = None) -> None: ...
    @property
...
class TranslationReplacementProxy:
    def __init__(self, translations_config: dict[str, dict[str, str]] | None, language_code: str | None) -> None: ...
...
class Conversation:
    ...
    def set_asr_biasing(self, keywords: list[str] | None = None, custom_biases: dict[str, float] | None = None) -> None: ...
    ...
    def send_sms(self, to_number: str, from_number: str, content: str, retry_count: int | None = None) -> dict | None: ...
    def send_whatsapp(self, to_number: str, from_number: str, content_id: str, content: str | None = '', retry_count: int | None = None) -> dict | None: ...
    def send_content_template(self, messaging_service_id: str, to_number: str, content_id: str, content: str | None = '', whatsapp: bool | None = False, content_variables: dict | None = None, retry_count: int | None = None) -> dict | None: ...
    def send_sms_template(self, to_number: str, template: str, retry_count: int | None = None) -> dict | None: ...
    ...
    def write_metric(self, name: str, value: float | int | str | None = None, *, write_once: bool = False): ...
    def call_handoff(self, destination: str, reason: str = None, utterance: str = None, sip_headers: dict[str, str] | None = None, route: str | None = None): ...
