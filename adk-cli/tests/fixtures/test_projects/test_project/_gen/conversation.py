...
from .sms import OutgoingSMS, OutgoingSMSTemplate, SMSCredentials, SMSTemplate
...
SupportedLanguageCodes = Literal['en-US', 'en-GB', 'es-US', 'es-ES', 'ar-SA', 'zh-CN', 'zh-TW', 'ja-JP', 'ko-KR', 'cs-CZ', 'nl-NL', 'en-AU', 'en-CA', 'en-IE', 'en-NZ', 'en-SG', 'fr-CA', 'fr-FR', 'fr-BE', 'de-DE', 'it-IT', 'pl-PL', 'pt-BR', 'pt-PT', 'sr-RS', 'es-ES', 'sv-SE', 'tr-TR', 'nl-BE', 'hr-HR', 'yue-HK', 'el-GR', 'hi-IN', 'bg-BG', 'bs-BA', 'sk-SK']
...
class ElevenLabsVoice(TTSVoice):
    ...
    def __init__(self, provider_voice_id: str, similarity_boost: float | None = ..., stability: float | None = ..., model_id: Literal['eleven_monolingual_v1', 'eleven_multilingual_v1', 'eleven_turbo_v2', 'eleven_turbo_v2_5', 'eleven_flash_v2_5'] | None = ..., speed: float | None = ...):
...
class RimeVoice(TTSVoice):
    ...
    def __init__(self, provider_voice_id: str, speech_alpha: float | None = ..., model_id: Literal['mist', 'mistv2'] | None = ...):
...
class Emotion:
    ...
    def __init__(self, kind: EmotionKindValue | None = ..., intensity: EmotionIntensityValue | None = ...):
...
class CartesiaVoice(TTSVoice):
    ...
    def __init__(self, provider_voice_id: str, speed: float | None = ..., emotions: list[Emotion] | None = ..., model_id: str | None = ..., volume: float | None = ..., emotion: str | None = ..., language: str | None = ...):
...
class MinimaxVoice(TTSVoice):
    ...
    def __init__(self, model_id: Literal['speech-02-hd', 'speech-02-turbo', 'speech-01-hd', 'speech-01-turbo'], voice_id: str, speed: float | None = ..., vol: float | None = ..., pitch: float | None = ..., emotion: Literal['happy', 'sad', 'angry', 'fearful', 'disgusted', 'surprised', 'neutral'] | None = ...):
...
class HumeVoice(TTSVoice):
    ...
    def __init__(self, provider_voice_id: str, voice_description: str | None = ..., version: str | None = ..., instant_mode: bool | None = ..., provider: Literal['CUSTOM_VOICE', 'HUME_AI'] | None = ...):
...
class GoogleVoice(TTSVoice):
    ...
    def __init__(self, provider_voice_id: str, gender: Literal['male', 'female', 'neutral'] | None = ...):
...
class HandoffConfig:
    ...
    sip_config: dict
    sip_headers: dict
    def __init__(self, sip_type: HandoffMethod, sip_config: dict = ..., sip_headers: dict = ...) -> None: ...
    @classmethod
...
class Handoff:
    ...
    def __init__(self, handoff: HandoffConfig, reason: str | None, destination: str | None = ...) -> None: ...
    @classmethod
    def from_dict(cls, d: dict):
        """from_dict"""
        ...
...
class ApiIntegrationData:
    ...
    def __init__(self, id: str, name: str, environments: dict[str, dict[str, str]], operations: list[dict[str, str]]) -> None: ...
...
class ASRBiasing:
    ...
    def __init__(self, keywords: list[str] | None = ..., custom_biases: dict[str, float] | None = ...) -> None: ...
...
class TranslationReplacementProxy:
    ...
    def __init__(self, translations_config: dict[str, dict[str, str]] | None, language_code: str | None): ...
...
class Conversation:
    ...
    def set_language(self, language: SupportedLanguageCodes):
        ...
        ...
    def set_asr_biasing(self, keywords: list[str] | None = ..., custom_biases: dict[str, float] | None = ...) -> None:
    ...
    def log_api_response(self, response: requests.models.Response, override_url: str = ...):
        ...
        ...
    def send_sms(self, to_number: str, from_number: str, content: str, retry_count: int | None = ...) -> dict | None:
        """Sends an SMS"""
        ...
    def send_whatsapp(self, to_number: str, from_number: str, content_id: str, content: str | None = ..., retry_count: int | None = ...) -> dict | None:
        """Sends a WhatsApp message"""
        ...
    def send_content_template(self, messaging_service_id: str, to_number: str, content_id: str, content: str | None = ..., whatsapp: bool | None = ..., content_variables: dict | None = ..., retry_count: int | None = ...) -> dict | None:
        """Sends a WhatsApp message"""
        ...
    def send_sms_template(self, to_number: str, template: str, retry_count: int | None = ...) -> dict | None:
    ...
    def set_csat_survey_entered(self):
        ...
        ...
    def set_background_track(self, name: str, loudness: float = ...):
        """Set a background track to play during the call."""
        ...
    ...
    def metric_events(self) -> list[MetricEvent]:
        ...
        ...
    def write_metric(self, name: str, value: float | int | str | None = ..., *, write_once: bool = ...):
        """Write a custom metric for call analytics."""
        ...
    def call_handoff(self, destination: str, reason: str = ..., utterance: str = ..., sip_headers: dict[str, str] | None = ..., route: str | None = ...):
...
def retrieve_sms_credentials(secret_name: str, secret_dict: dict[str, Any], project_id: str, integration: str) -> SMSCredentials:
    """Retrieve SMS credentials from secret_dict"""
    ...

EmotionKindValue = NewType('EmotionKindValue', int)
EmotionIntensityValue = NewType('EmotionIntensityValue', int)
VoiceType = CustomVoice | ElevenLabsVoice | PlayHTVoice | CartesiaVoice | RimeVoice | MinimaxVoice | HumeVoice | GoogleVoice
