...
- The .proto definitions are owned by the backend service, so they cannot be changed from this repo.
- TODO comments found in generated files are inherited from upstream `.proto` definitions.
- Treat those TODO comments as non-actionable in Rust parity audits unless there is a concrete runtime or feature failure tied to schema limitations.
