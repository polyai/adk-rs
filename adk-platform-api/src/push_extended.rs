...
use crate::{
    actor_identity, clean_name, extract_entities_map, extract_variable_names_from_code,
    generated_or_stable_resource_id, push_command,
};
...
fn local_resource_id(resource: &adk_domain::Resource) -> Option<String> {
