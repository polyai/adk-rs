...
| [#152](https://github.com/polyai/adk/pull/152) | 2026-05-29 | Adds `Translation`, `DefaultLanguage`, and `AdditionalLanguage` resources plus language/translation validation. | **Covered.** Rust now materializes, discovers, statuses, validates, and pushes `agent_settings/languages.yaml` and `config/translations.yaml`, including default-language updates, additional-language create/delete, translation create/update/delete, and non-`name` translation-key matching. |
