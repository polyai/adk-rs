...
EntityConfig = NumericConfig | QuantityConfig | CurrencyConfig | NameConfig | FreeTextConfig | AlphanumericConfig | DateConfig | EmailConfig | TimeConfig | PhoneNumberConfig | EnumConfig
