...
pub(crate) fn empty_discovered_resource_paths() -> DiscoveredResourcePaths {
...
pub(crate) fn type_name_to_resource_prefix(type_name: &str) -> Option<&'static str> {
...
pub(crate) fn build_typed_resource_lifecycle(
...
pub(crate) fn find_new_kept_deleted(
